...
function Layout() {
  return (
    <div className="min-h-screen flex flex-col dark:bg-slate-900 dark:text-white">
      <header className="flex justify-between bg-pink-500 text-white p-4">
        <img src="https://turtle-quest.vercel.app/assets/favicon-B1ZwkIgi.svg" alt="MSTN Logo" className="w-16 h-16" />
